<%-- StudentForm.aspx - Create/Edit form --%>
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <asp:CompareValidator ID="cvDateOfBirth" runat="server"
                        ControlToValidate="txtDateOfBirth" ErrorMessage="Date of Birth must be in the past."
                        Operator="LessThan" Type="Date" ValueToCompare='<%# DateTime.Now.ToString("yyyy-MM-dd") %>'
